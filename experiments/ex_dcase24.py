...
def default_config():
    loss_function = 'nt-xent'  #cross entropy
...
class AudioRetrievalModel(pl.LightningModule, ABC):
    ...
    def validation_step(self, batch, batch_idx, dl_index=0, mode='val'):
        ...
        args = {
            ...
            'sentence_features': sentence_features[:, :1].detach().clone(),
            'sentence_mask': sentence_mask[:, :1].detach().clone(),

...
Corresponding prompt and script are provided in ```experiments/generate_captions_phi4.py```. Clotho ndevelopment captions along with generated ones are located in ```clotho_v2/clotho_captions_development_plus_phi_generated.csv```
